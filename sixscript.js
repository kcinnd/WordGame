document.addEventListener('DOMContentLoaded', () => {
    const words = ['global', 'domain', 'county', 'legend', 'leader', 'oceans', 'plants', 'animal', 'flower', 'forest', 'castle', 'planet', 'island', 'travel', 'nature', 'market', 'jungle', 'canyon', 'desert', 'region'];
